...
- **Kaynak güvenilirliği**: Skill'ler ("hakem-simulasyonu", "cagri-tarama") sayısal değerleri (bütçe limiti, süre, tarih) uydurmamak için gerçek kaynağa ihtiyaç duyar. Sizin indirdiğiniz resmi PDF, en güvenilir kaynaktır.
